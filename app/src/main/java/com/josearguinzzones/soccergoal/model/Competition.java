...
public class Competition {
    ...
    public Competition(String id, String league, String currentMatchDay, String numberOfMatchdays, String numberOfTeams, String numberOfGames, String leagueShortened) {
        this.id = id;
        this.league = league;
    ...
    public String toString() {
        return "Competition{" +
                ...
                ", leagueShortened='" + leagueShortened + '\'' +
                '}';
    }
}
